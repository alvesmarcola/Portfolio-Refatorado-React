        ...
        >
            <div className="about__container grid">
                ...
                <div className="about__img-container">
                    <h2 className="section__title" data-translate="aboutme">Sobre mim</h2>
                ...
                <div className="about__data">
                    <div className="about__info">
                        <p className="about__description" data-translate="descricao-profissional">
                    ...
                    <div className="skills__container">
                        <div className="skills__data">
                            <div className="skills__titles">
                                <h3 className="skills__name" data-translate="front">Desenvolvimento Front end</h3>
                        ...
                        <div className="skills__data">
                            <div className="skills__titles">
                                <h3 className="skills__name" data-translate="back">Desenvolvimento Back End</h3>
